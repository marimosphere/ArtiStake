    ...
    <div className="w-full mx-auto bg-marimo-1">
      <div className="flex pt-4 pb-8 grid lg:grid-cols-2">
        <div className="flex px-2 py-2 lg:px-8">
          ...
          <div className="ml-4">
            <p className="text-black text-2xl mb-2">{name}</p>
      ...
      <div className="bg-marimo-3 text-black">
        <p className="ml-8 text-lg py-1">About This Project</p>
      </div>
      {mywork ? (
        <div className="flex grid lg:grid-cols-5 ">
          <p className="about-my-work text-black text-md p-8 lg:col-span-3">{aboutMyWork}</p>
        ...
        <div>
          <p className="about-my-work text-black text-md p-8">{aboutMyWork}</p>
        </div>
      )}
    </div>
  );
